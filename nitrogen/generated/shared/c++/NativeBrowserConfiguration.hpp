...
namespace margelo::nitro::audiobrowser {
  ...
  public:
    // NativeBrowserConfiguration is not equatable because these properties are not equatable: request, media, artwork, routes, handleTrackLoad, formatNavigationError
  };
